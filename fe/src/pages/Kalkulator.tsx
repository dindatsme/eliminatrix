...
export default function Kalkulator() {
  ...
  const handleCalculate = async (Input: SolveMatrixRequest) => {
  ...
  return (
    <div className="container md:min-h-[calc(100vh-250px)] pb-6 space-y-12 bg-main-background">
      <div className="space-y-3">
        <h1 className="text-2xl font-libre-franklin font-medium text-main-foreground">
          Kalkulator Eliminatrix
        </h1>
        <p className="text-xs font-orienta text-main-foreground">
          Sebuah Kalkulator untuk menyelesaikan SPL dengan metode eliminasi
          Gauss maupun Gauss-Jordan. Membantu Anda memperoleh solusi
          step-by-step secara cepat, edukatif, dan ringkas.
        </p>
      </div>
